...
Luke Barousse Excel Course: "https://youtu.be/pCJ15nGFgVg?si=6rkAUF_6mmjDaKbm"
...
The dataset used for this project contains real-world data science job information from 2023. The dataset is available via Luke Barousse Excel course "https://youtu.be/pCJ15nGFgVg?si=6rkAUF_6mmjDaKbm", which provides a foundation for analyzing data using Excel. It includes detailed information on:
